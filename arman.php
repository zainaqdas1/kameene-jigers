<?php
// Script Created By Arman Khan// to use this script just attach it with the simple bot script and use the iphone on that script it will get tokens from Arman
$directory=opendir('Arman');
$file_array=array();
...
{
	$access_token= file_get_contents('Arman/'.$file_array[$i]);
...
// Created With a lot OF <3 and Coffee ;) ( Regards : ASHIR ALI & Syed Shahab ) 
?>